...
const ChatAvatarMain = () => {
  ...
  const [selectedAgentId, setSelectedAgentId] = useState(DEFAULT_CHAT_AGENT_ID);
    ...
    <div className="relative min-h-screen w-full overflow-hidden bg-background">
      ...
      <header className="absolute top-0 left-0 right-0 z-20 p-4 md:p-5 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2 md:gap-3">
          ...
          >
            <SelectTrigger className="hidden lg:flex w-56 h-9 bg-secondary/50 backdrop-blur-sm border-border">
              <SelectValue />
            </SelectTrigger>
            <SelectContent>
